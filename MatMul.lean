...
symbolic. The proof is a chain of `with_unfolding_all rfl` segments
over scalar-parameterized heap fronts (every index concrete, every
value an opaque `Int`), split only to bound elaboration cost, plus the
three `enterFrame` facts (the only program-consulting steps, the only
places `matmulLowered` unfolds outside the pins and the entry
equation).
...
`rfl` rather than by hand-counted normalize depths.
-/
...
theorem un_idem (v : Int) : un (un v) = un v := by
...
/-- GAP-WITNESS (kit gap A1-wrap, third consumer after DotProduct — and
the conditioned no-wrap form in PowMod): WRAPPING uint64 multiplication
of two `Nat`-cast values. Re-derived minimally as the recorded-gap
witness; in THIS module the towers collapse through `unn_collapse` +
`omega` instead (the `b`-side factors are literals, so every goal is
linear), and this lemma is not a load-bearing step. -/
...
theorem matmul_ok (seed : Nat) (hseed : seed < 2 ^ 64) :
  ...
  rw [show (8 + 1 + 59 + 291 + 291 + 291 + 33 + 1 + 59 + 58 + 65 + 65 + 65 + 38 + 58 + 65 + 65 + 65 + 38 + 58 + 65 + 65 + 65 + 38 + 35 + 1 + 59 + 58 + 62 + 69 + 69 + 69 + 53 + 62 + 69 + 69 + 69 + 53 + 62 + 69 + 69 + 69 + 53 + 38 + 58 + 62 + 69 + 69 + 69 + 53 + 62 + 69 + 69 + 69 + 53 + 62 + 69 + 69 + 69 + 53 + 38 + 58 + 62 + 69 + 69 + 69 + 53 + 62 + 69 + 69 + 69 + 53 + 62 + 69 + 69 + 69 + 53 + 38 + 59 : Nat) = 5247 from by norm_num] at h79
