...
| Interfaces | partial | `interfaces/nil-interface`, `interfaces/interface-compare`, `interfaces/type-assertions`, `interfaces/type-switch-nil`, `interfaces/type-switch-dynamic`, `interfaces/type-switch-typed-nil` | Add interface method calls, embedding interactions, dynamic equality inside structs, nil typed values across more dynamic types, and type switch cases with multiple listed types. |
