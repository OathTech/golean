...
| `pointers/zero-size-address/escaped-same` | 1 | **L:R15** — a latitude-pinned red (inventory R15), version-tracked; re-envelope obligation re-homed 2026-08-31 ([AGENT] extension of fidelity decision 6's orphan class; R15 fits the class, [USER] confirmation pending) from the parked W3.2 arc to this repo's TODO.md backlog |
