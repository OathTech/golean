...
All numbers at the current tracked baseline (3350 cases, 3157 PASS /
193 FAIL — the round-10 merge-train UNION 2026-09-04 [AGENT], under the
...
sides' row deltas are disjoint (checked by id). The paragraphs below are
