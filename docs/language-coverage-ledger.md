...
All numbers at the current tracked baseline (3255 cases, 3065 PASS /
190 FAIL — the round-8b merge-train UNION 2026-09-03 [AGENT] of the
...
base — 56 born rows under `stdlib-source/` (54 PASS / 2 FAIL, the born
ids disjoint from every main row), 6 FAIL→PASS flip(s), 0 PASS→FAIL
flip(s) — = 3255 / 3065 / 190: 3199 + 56 = 3255; 3005 + 54 + 6 − 0 = 3065;
194 + 2 − 6 + 0 = 190; re-derived from the union baseline's data rows,
not summed by hand (the lane's own figure at this commit was 3251 / 3061 / 190).
The two records, in merge order: (i) the lane's own — (3251 cases, 3061 PASS /
190 FAIL — the `stdlib-source-1` re-pin 2026-09-03 [AGENT], stdlib
source-through slice 1: the previous pin's 3195 / 3001 / 194 with six
shim-surface FAIL/frontend-export rows flipped PASS by the real library
source — `strings/split-conformance/empty-sep`, `strings/shim-value-refused/{shimmed-value,unmodeled-value}`,
`strconv/format-parse/unmodeled-member`, `panic-recover/shim-refusal-unrecoverable/{split-recover,render-recover}`
— plus 56 born rows under `stdlib-source/` (54 PASS + 2 FAIL by design
on FR-16's Cases): 3195 + 56 = 3251; 3001 + 6 + 54 = 3061; 194 − 6 + 2
= 190 — re-derived from the data rows. (ii) main's chain — (3199 cases, 3005 PASS /
