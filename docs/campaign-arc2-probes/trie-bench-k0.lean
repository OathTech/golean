/- Campaign Arc 2, U3 microbench kernel point nops=0. Expected value
confirmed compiled first (trie-bench.lean #eval: bench 0 = 36376). -/
...
example : bench 0 = 36376 := by with_unfolding_all rfl
