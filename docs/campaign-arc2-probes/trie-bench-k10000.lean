/- Campaign Arc 2, U3 microbench kernel point nops=10000. Expected value
confirmed compiled first (trie-bench.lean #eval: bench 10000 = 91330912). -/
...
example : bench 10000 = 91330912 := by with_unfolding_all rfl
