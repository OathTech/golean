...
//   primes: len folded into the first return (9*10+6=96) and two
//   load-bearing elements checked (the spec's 9 at
//   index 4 and 2147483647 at index 5; full-content claim trimmed at
//   the P3 audit N3);
...
func complitKeyedExamples() (int, int, bool, bool, bool, float32, int) {
	...
	return primes[4]*10 + len(primes), primes[5], vowels['a'] && vowels['y'], vowels['b'],
