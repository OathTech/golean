...
// source: testdata/examples/semantics/slices.go @ 3be88bbb4982f58e5813b6f0344302d5582c8e8a
...
func goleanTestSliceCapacityOps() int {
	if testSliceCapacityOps() {
		return 1
	}
	return 0
}

func goleanTestOverwriteArray() int {
	if testOverwriteArray() {
		return 1
	}
	return 0
}

func goleanTestSliceLiteral() int {
	if testSliceLiteral() {
		return 1
	}
	return 0
...
func goleanTestSliceAppend() int {
	if testSliceAppend() {
		return 1
	}
	return 0
