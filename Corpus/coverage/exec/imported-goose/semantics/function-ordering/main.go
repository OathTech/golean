...
// source: testdata/examples/semantics/function_ordering.go @ 3be88bbb4982f58e5813b6f0344302d5582c8e8a
...
func goleanFailing_testFunctionOrdering() int {
	if failing_testFunctionOrdering() {
		return 1
	}
	return 0
}

func goleanFailing_testArgumentOrder() int {
	if failing_testArgumentOrder() {
		return 1
	}
	return 0
}
