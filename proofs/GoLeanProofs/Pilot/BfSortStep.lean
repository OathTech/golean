...
theorem uSort_leaf_00 (tenv : LocalEnv) (k : SymCont) (ρ : Valuation)
    (σ : ExecState) (a : Int)
    (ch : Choices) :
    stepFn (γS (uρ ρ a 1 2 3) σ uS11) (γC (uρ ρ a 1 2 3) (uC11 tenv k)) ch
      = .ok (γC (uρ ρ a 1 2 3) (uC12 tenv k), γS (uρ ρ a 1 2 3) σ uS12, ch) := by
  kernel_rfl

theorem uSort_leaf_01 (tenv : LocalEnv) (k : SymCont) (ρ : Valuation)
    (σ : ExecState) (a : Int)
    (ch : Choices) :
    stepFn (γS (uρ ρ a 1 3 2) σ uS11) (γC (uρ ρ a 1 3 2) (uC11 tenv k)) ch
      = .ok (γC (uρ ρ a 1 3 2) (uC12 tenv k), γS (uρ ρ a 1 3 2) σ uS12, ch) := by
  kernel_rfl

theorem uSort_leaf_10 (tenv : LocalEnv) (k : SymCont) (ρ : Valuation)
    (σ : ExecState) (a : Int)
    (ch : Choices) :
    stepFn (γS (uρ ρ a 2 1 3) σ uS11) (γC (uρ ρ a 2 1 3) (uC11 tenv k)) ch
      = .ok (γC (uρ ρ a 2 1 3) (uC12 tenv k), γS (uρ ρ a 2 1 3) σ uS12, ch) := by
  kernel_rfl

theorem uSort_leaf_11 (tenv : LocalEnv) (k : SymCont) (ρ : Valuation)
    (σ : ExecState) (a : Int)
    (ch : Choices) :
    stepFn (γS (uρ ρ a 2 3 1) σ uS11) (γC (uρ ρ a 2 3 1) (uC11 tenv k)) ch
      = .ok (γC (uρ ρ a 2 3 1) (uC12 tenv k), γS (uρ ρ a 2 3 1) σ uS12, ch) := by
  kernel_rfl

theorem uSort_leaf_20 (tenv : LocalEnv) (k : SymCont) (ρ : Valuation)
    (σ : ExecState) (a : Int)
    (ch : Choices) :
    stepFn (γS (uρ ρ a 3 1 2) σ uS11) (γC (uρ ρ a 3 1 2) (uC11 tenv k)) ch
      = .ok (γC (uρ ρ a 3 1 2) (uC12 tenv k), γS (uρ ρ a 3 1 2) σ uS12, ch) := by
  kernel_rfl

theorem uSort_leaf_21 (tenv : LocalEnv) (k : SymCont) (ρ : Valuation)
    (σ : ExecState) (a : Int)
    (ch : Choices) :
    stepFn (γS (uρ ρ a 3 2 1) σ uS11) (γC (uρ ρ a 3 2 1) (uC11 tenv k)) ch
      = .ok (γC (uρ ρ a 3 2 1) (uC12 tenv k), γS (uρ ρ a 3 2 1) σ uS12, ch) := by
  kernel_rfl

theorem uSort_step (tenv : LocalEnv) (k : SymCont) (ρ : Valuation)
    (σ : ExecState) (a : Int) (c₂ c₃ : Nat) (ch : Choices) :
    stepFn (γS (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) σ uS11)
      (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) (uC11 tenv k)) ch
      = .ok (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) (uC12 tenv k),
