...
/-!
# The `matmul` example — the frontend's lowering, pinned
(gallery campaign G1, guardrails wave, 2026-08-15)

`matmulLowered` is the native frontend's ACTUAL lowering of the
canonical corpus source (`Corpus/coverage/exec/examples/matmul/main.go`,
differentially green against `go run`), pinned by `scripts/check-golden`
against `baselines/golden/matmul-lowered.repr`. THIS DEF IS GENERATED from
...
/-- The frontend's lowering of the `matmul` subject, verbatim
(`scripts/check-golden` pins it). -/
def matmulLowered : Program :=
  { typeDefs := #[({ key := "struct{}" }, GoLean.GoCore.TypeDef.struct #[])],
    funcs := #[{ id := { key := "matMul" },
                 args := #[{ id := "a",
                             typ := GoLean.GoCore.Ty.array
                                      3
                                      (GoLean.GoCore.Ty.array 3 (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) },
                           { id := "b",
                             typ := GoLean.GoCore.Ty.array
                                      3
                                      (GoLean.GoCore.Ty.array 3 (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) }],
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                 ...
                                 GoLean.GoCore.Stmt.call
                                   ...
                                   { key := "matMul" }
                                   #[GoLean.GoCore.Expr.var "$c3", GoLean.GoCore.Expr.var "$c4"]],
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.assign
                                   (GoLean.GoCore.Assignee.var "$res0")
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                 ...
                                 GoLean.GoCore.Stmt.call
                                   ...
                                   { key := "matMul" }
                                   #[GoLean.GoCore.Expr.var "$c6", GoLean.GoCore.Expr.var "$c7"]],
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.assign
                                   (GoLean.GoCore.Assignee.var "$res0")
                                   (GoLean.GoCore.Expr.indexGet
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                 ...
                                 GoLean.GoCore.Stmt.call
                                   #[GoLean.GoCore.Assignee.var "c"]
                                   { key := "matMul" }
                                   #[GoLean.GoCore.Expr.var "m", GoLean.GoCore.Expr.var "m"]],
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.assign
                                   (GoLean.GoCore.Assignee.var "$res0")
                                   (GoLean.GoCore.Expr.add
