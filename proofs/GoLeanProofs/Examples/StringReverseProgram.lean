...
/-!
# The `strrev` example — the frontend's lowering, pinned
(gallery campaign G1, guardrails wave, 2026-08-15)

`strrevLowered` is the native frontend's ACTUAL lowering of the
canonical corpus source (`Corpus/coverage/exec/examples/strrev/main.go`,
differentially green against `go run`), pinned by `scripts/check-golden`
against `baselines/golden/strrev-lowered.repr`. THIS DEF IS GENERATED from
...
/-- The frontend's lowering of the `strrev` subject, verbatim
(`scripts/check-golden` pins it). -/
def strrevLowered : Program :=
  { typeDefs := #[({ key := "struct{}" }, GoLean.GoCore.TypeDef.struct #[])],
    funcs := #[{ id := { key := "reverseString" },
               ...
               { id := { key := "revBuilt" },
                 ...
                 body := GoLean.GoCore.Stmt.block
                           #[]
                           #[GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization { id := "$c0", typ := GoLean.GoCore.Ty.string },
               ...
               { id := { key := "palinBuilt" },
                 ...
                 body := GoLean.GoCore.Stmt.block
                           #[]
                           #[GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization { id := "$c2", typ := GoLean.GoCore.Ty.string },
                                 GoLean.GoCore.Stmt.call
               ...
               { id := { key := "revLit" },
                 ...
                 body := GoLean.GoCore.Stmt.block
                           #[]
                           #[GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization { id := "$c4", typ := GoLean.GoCore.Ty.string },
                                 GoLean.GoCore.Stmt.call
                                   #[GoLean.GoCore.Assignee.var "$c4"]
                                   { key := "reverseString" }
                                   #[GoLean.GoCore.Expr.stringLit { bytes := #[97, 98, 99, 100] }]],
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.assign
                                   (GoLean.GoCore.Assignee.var "$res0")
                           ...
                           #[GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                 ...
                                 GoLean.GoCore.Stmt.call
                                   ...
                                   { key := "isStringPalindrome" }
                                   #[GoLean.GoCore.Expr.stringLit { bytes := #[97, 98, 99, 98, 97] }]],
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.assign
                                   (GoLean.GoCore.Assignee.var "$res0")
