...
/-!
# The `kadane` example — the frontend's lowering, pinned
(gallery campaign G1, guardrails wave, 2026-08-15)

`kadaneLowered` is the native frontend's ACTUAL lowering of the
canonical corpus source (`Corpus/coverage/exec/examples/kadane/main.go`,
differentially green against `go run`), pinned by `scripts/check-golden`
against `baselines/golden/kadane-lowered.repr`. THIS DEF IS GENERATED from
...
/-- The frontend's lowering of the `kadane` subject, verbatim
(`scripts/check-golden` pins it). -/
def kadaneLowered : Program :=
  { typeDefs := #[({ key := "struct{}" }, GoLean.GoCore.TypeDef.struct #[])],
    funcs := #[{ id := { key := "kadane" },
                 args := #[{ id := "s",
                             typ := GoLean.GoCore.Ty.slice (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64)) }],
                 results := #[{ id := "$res0", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) }],
                           ...
                           #[GoLean.GoCore.Stmt.ifThenElse
                               (GoLean.GoCore.Expr.eqCmp
                                 ...
                                 (GoLean.GoCore.Expr.length
                                   ...
                                   (some (GoLean.GoCore.Ty.slice (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64)))))
                               ...
                               (GoLean.GoCore.Stmt.block
                                 ...
                                 #[GoLean.GoCore.Stmt.seqn
                                     #[GoLean.GoCore.Stmt.assign
                                         ...
                                         (GoLean.GoCore.Expr.intLit 0 (GoLean.GoCore.IntKind.int64)),
                                       GoLean.GoCore.Stmt.returnStmt]])
                               (GoLean.GoCore.Stmt.seqn #[]),
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                   { id := "best", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                                 GoLean.GoCore.Stmt.assign
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                   { id := "cur", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                                 GoLean.GoCore.Stmt.assign
                                   (GoLean.GoCore.Assignee.var "cur")
                                   (GoLean.GoCore.Expr.indexGet
                                     (GoLean.GoCore.Expr.var "s")
                                     (GoLean.GoCore.Expr.intLit 0 (GoLean.GoCore.IntKind.int)))],
                             GoLean.GoCore.Stmt.block
                                             ...
                                             (GoLean.GoCore.Expr.lessCmp
                                               ...
                                               (GoLean.GoCore.Expr.length
                                                 ...
                                                 (some (GoLean.GoCore.Ty.slice
                                                    (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64))))))
                                             (GoLean.GoCore.Stmt.seqn #[])
                 ...
                 wrapper := false },
               { id := { key := "kadaneFour" },
                 args := #[{ id := "a", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                           { id := "b", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                           { id := "c", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                           { id := "d", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) }],
                 results := #[{ id := "$res0", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) }],
                 body := GoLean.GoCore.Stmt.block
                           #[]
                           #[GoLean.GoCore.Stmt.seqn
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                   { id := "$c1", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
               ...
               { id := { key := "kadaneThree" },
                 ...
                 body := GoLean.GoCore.Stmt.block
                           ...
                           #[GoLean.GoCore.Stmt.seqn
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                   { id := "$c3", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                                 GoLean.GoCore.Stmt.call
               ...
               { id := { key := "kadaneOne" },
                 ...
                 body := GoLean.GoCore.Stmt.block
                           ...
                           #[GoLean.GoCore.Stmt.seqn
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                   { id := "$c5", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                                 GoLean.GoCore.Stmt.call
               ...
               { id := { key := "kadaneEmpty" },
                 ...
                 body := GoLean.GoCore.Stmt.block
                           ...
                           #[GoLean.GoCore.Stmt.seqn
                             ...
                             GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                                   { id := "$c7", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                                 GoLean.GoCore.Stmt.call
               ...
               { id := { key := "kadane_harness_r" },
                 args := #[{ id := "n", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                           { id := "seed", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) }],
                 results := #[{ id := "$res0",
                                typ := GoLean.GoCore.Ty.array 8 (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64)) },
                              { id := "$res1", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) }],
                 body := GoLean.GoCore.Stmt.block
                           #[]
                           #[GoLean.GoCore.Stmt.seqn
                               #[GoLean.GoCore.Stmt.initialization
                             ...
                             GoLean.GoCore.Stmt.block
                               ...
                               #[GoLean.GoCore.Stmt.seqn
                                   #[GoLean.GoCore.Stmt.initialization
                                       { id := "i", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int64) },
                                     GoLean.GoCore.Stmt.assign
                                       (GoLean.GoCore.Assignee.var "i")
                                       (GoLean.GoCore.Expr.intLit 0 (GoLean.GoCore.IntKind.int64))],
                                 GoLean.GoCore.Stmt.block
                                       ...
                                       (GoLean.GoCore.Stmt.block
                                         ...
                                         #[GoLean.GoCore.Stmt.ifThenElse
                                             ...
                                             (GoLean.GoCore.Stmt.assign
                                               ...
                                               (GoLean.GoCore.Expr.add
                                                 (GoLean.GoCore.Expr.var "i")
                                                 (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.int64)))),
                                           GoLean.GoCore.Stmt.seqn #[],
                                           GoLean.GoCore.Stmt.ifThenElse
                                             (GoLean.GoCore.Expr.lessCmp
                                               (GoLean.GoCore.Expr.var "i")
                                               ...
                                               GoLean.GoCore.Stmt.ifThenElse
                                                 (GoLean.GoCore.Expr.eqCmp
                                                   ...
                                                   (GoLean.GoCore.Expr.mod
                                                     (GoLean.GoCore.Expr.var "i")
                                                     (GoLean.GoCore.Expr.intLit 2 (GoLean.GoCore.IntKind.int64)))
                                                   (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.int64)))
                                                 (GoLean.GoCore.Stmt.block
                                                   #[]
                                                   #[GoLean.GoCore.Stmt.seqn
