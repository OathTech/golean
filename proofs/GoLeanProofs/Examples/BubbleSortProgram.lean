...
/-!
# The `bubble` example — the frontend's lowering, pinned
(gallery campaign G1, guardrails wave, 2026-08-15)

`bubbleLowered` is the native frontend's ACTUAL lowering of the
canonical corpus source (`Corpus/coverage/exec/examples/bubble/main.go`,
differentially green against `go run`), pinned by `scripts/check-golden`
against `baselines/golden/bubble-lowered.repr`. THIS DEF IS GENERATED from
...
/-- The frontend's lowering of the `bubble` subject, verbatim
(`scripts/check-golden` pins it). -/
def bubbleLowered : Program :=
  { typeDefs := #[({ key := "struct{}" }, GoLean.GoCore.TypeDef.struct #[])],
    funcs := #[{ id := { key := "bubbleSort" },
                 args := #[{ id := "s",
                           ...
                           #[GoLean.GoCore.Stmt.block
                               ...
                               #[GoLean.GoCore.Stmt.seqn
                                   #[GoLean.GoCore.Stmt.initialization
                                       { id := "end", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int) },
                                     GoLean.GoCore.Stmt.assign
                                       (GoLean.GoCore.Assignee.var "end")
                                       ...
                                       (GoLean.GoCore.Stmt.block
                                         ...
                                         #[GoLean.GoCore.Stmt.ifThenElse
                                           ...
                                           GoLean.GoCore.Stmt.block
                                             ...
                                             #[GoLean.GoCore.Stmt.seqn
                                                 #[GoLean.GoCore.Stmt.initialization
                                                     { id := "swapped", typ := GoLean.GoCore.Ty.bool },
                                                   GoLean.GoCore.Stmt.assign
                                                     (GoLean.GoCore.Assignee.var "swapped")
                                                     (GoLean.GoCore.Expr.boolLit false)],
                                               GoLean.GoCore.Stmt.block
                                                 #[]
                                                 #[GoLean.GoCore.Stmt.seqn
                                                           ...
                                                           #[GoLean.GoCore.Stmt.ifThenElse
                                                             ...
                                                             GoLean.GoCore.Stmt.block
                                                               ...
                                                               #[GoLean.GoCore.Stmt.ifThenElse
                                                                   ...
                                                                   (GoLean.GoCore.Stmt.seqn #[])]])]],
                                               GoLean.GoCore.Stmt.ifThenElse
                                                 (GoLean.GoCore.Expr.not (GoLean.GoCore.Expr.var "swapped"))
                                                 (GoLean.GoCore.Stmt.block #[] #[GoLean.GoCore.Stmt.returnStmt])
                                                 (GoLean.GoCore.Stmt.seqn #[])]])]]],
                 variadic := false,
                 wrapper := false },
               { id := { key := "sortFour" },
