...
def vrSB25 : SymState :=
  ...
  ((GoLean.Loc.base { id := 8437 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 2) (GoLean.GoCore.IntKind.uint64))))]
  8438)

def vrCB25 : SymConfig :=
  ...
  #[GoLean.GoCore.Stmt.assign
    ...
    GoLean.GoCore.Stmt.seqn
      #[GoLean.GoCore.Stmt.assign
          ...
          (GoLean.GoCore.Expr.var "id")]]) ([[("id", GoLean.Loc.base { id := 8437 })],
      ...
      (GoLean.Sym.SymInt.norm
        ...
        (GoLean.Sym.SymInt.norm
          ...
          (GoLean.Sym.SymInt.sub
            ...
            (GoLean.Sym.SymInt.lit 1))))
      (GoLean.Sym.SymInt.lit 1)))) (GoLean.GoCore.IntKind.int)))),
  ((GoLean.Loc.base { id := 8434 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.array 7 (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)))) (GoLean.Sym.Value.array #[(GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0))) (GoLean.GoCore.IntKind.uint64)),
  (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
...
def vrSB27 : SymState :=
  ...
  ((GoLean.Loc.base { id := 8436 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 1) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 8437 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 2) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 8438 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 3) (GoLean.GoCore.IntKind.uint64))))]
  8439)

def vrCB27 : SymConfig :=
  (GoLean.Sym.Config.exec (GoLean.GoCore.Stmt.block
  #[]
  #[GoLean.GoCore.Stmt.assign
      (GoLean.GoCore.Assignee.var "n")
    ...
    GoLean.GoCore.Stmt.seqn
      #[GoLean.GoCore.Stmt.assign
          (GoLean.GoCore.Assignee.addr
            (GoLean.GoCore.Expr.indexAddr (GoLean.GoCore.Expr.var "ids") (GoLean.GoCore.Expr.var "n")))
          (GoLean.GoCore.Expr.var "id")]]) ([[("id", GoLean.Loc.base { id := 8438 })],
 [("ids", GoLean.Loc.base { id := 8435 }),
  ("sl", GoLean.Loc.base { id := 8434 }),
  ("n", GoLean.Loc.base { id := 8433 })],
 [("f", GoLean.Loc.base { id := 8432 }), ("p", GoLean.Loc.base { id := 8431 })]]) (GoLean.Sym.Cont.mapIterK (some "id") (none) (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)) (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "tracker.Progress" })) (GoLean.GoCore.Stmt.block
...
def vrCB29 : SymConfig :=
  (GoLean.Sym.Config.next (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.sortSlice (GoLean.GoCore.Expr.var "ids") (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)),
 GoLean.GoCore.Stmt.block
   #[]
   #[GoLean.GoCore.Stmt.initialization
       { id := "$rcoll", typ := GoLean.GoCore.Ty.slice (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)) },
