...
def vrSB15 : SymState :=
  ...
  ((GoLean.Loc.base { id := 8377 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "quorum.VoteResult" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint8)))),
  ...
  ((GoLean.Loc.base { id := 8380 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "quorum.VoteResult" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint8)))),
  ((GoLean.Loc.base { id := 8381 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "quorum.VoteResult" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint8)))),
  ...
  ((GoLean.Loc.base { id := 8384 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "quorum.VoteResult" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint8)))),
  ...
  ((GoLean.Loc.base { id := 8386 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.int)))),
...
def vrCB15 : SymConfig :=
  ...
  #[GoLean.GoCore.Stmt.seqn
    ...
    GoLean.GoCore.Stmt.ifThenElse
      (GoLean.GoCore.Expr.not (GoLean.GoCore.Expr.var "ok"))
      (GoLean.GoCore.Stmt.block
        #[]
        #[GoLean.GoCore.Stmt.assign
            (GoLean.GoCore.Assignee.var "missing")
            (GoLean.GoCore.Expr.add
              (GoLean.GoCore.Expr.var "missing")
    ...
    GoLean.GoCore.Stmt.ifThenElse
      ...
      (GoLean.GoCore.Stmt.block
        #[]
        #[GoLean.GoCore.Stmt.assign
            (GoLean.GoCore.Assignee.var "votedCnt")
            (GoLean.GoCore.Expr.add
              (GoLean.GoCore.Expr.var "votedCnt")
              (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.int)))])
      (GoLean.GoCore.Stmt.seqn #[])]) ([[("id", GoLean.Loc.base { id := 8390 })],
 [("missing", GoLean.Loc.base { id := 8386 }), ("votedCnt", GoLean.Loc.base { id := 8385 })],
 [("$res0", GoLean.Loc.base { id := 8384 }),
  ("votes", GoLean.Loc.base { id := 8383 }),
  ("c", GoLean.Loc.base { id := 8382 })]]) (GoLean.Sym.Cont.mapIterK (some "id") (none) (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)) (GoLean.GoCore.Ty.defined { key := "struct{}" }) (GoLean.GoCore.Stmt.block
  #[]
  #[GoLean.GoCore.Stmt.seqn
      #[GoLean.GoCore.Stmt.initialization { id := "v", typ := GoLean.GoCore.Ty.bool },
        GoLean.GoCore.Stmt.initialization { id := "ok", typ := GoLean.GoCore.Ty.bool },
  ...
  (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 3) (GoLean.GoCore.IntKind.uint64))] ([[("missing", GoLean.Loc.base { id := 8386 }), ("votedCnt", GoLean.Loc.base { id := 8385 })],
 [("$res0", GoLean.Loc.base { id := 8384 }),
  ("votes", GoLean.Loc.base { id := 8383 }),
  ("c", GoLean.Loc.base { id := 8382 })]]) (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.initialization { id := "q", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int) },
     GoLean.GoCore.Stmt.assign
       ...
       (GoLean.GoCore.Expr.add
         (GoLean.GoCore.Expr.div
           (GoLean.GoCore.Expr.length
             ...
             (some (GoLean.GoCore.Ty.defined { key := "quorum.MajorityConfig" })))
           (GoLean.GoCore.Expr.intLit 2 (GoLean.GoCore.IntKind.int)))
         (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.int)))],
 GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.atLeastCmp (GoLean.GoCore.Expr.var "votedCnt") (GoLean.GoCore.Expr.var "q"))
   (GoLean.GoCore.Stmt.block
     #[]
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign
 ...
 GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.atLeastCmp
     (GoLean.GoCore.Expr.add (GoLean.GoCore.Expr.var "votedCnt") (GoLean.GoCore.Expr.var "missing"))
   ...
   (GoLean.GoCore.Stmt.block
     ...
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign
             (GoLean.GoCore.Assignee.var "$res0")
             (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.uint8)),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign
     ...
     GoLean.GoCore.Stmt.returnStmt]]) ([[("missing", GoLean.Loc.base { id := 8386 }), ("votedCnt", GoLean.Loc.base { id := 8385 })],
 [("$res0", GoLean.Loc.base { id := 8384 }),
  ("votes", GoLean.Loc.base { id := 8383 }),
  ("c", GoLean.Loc.base { id := 8382 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "r1"])]) ([[("r1", GoLean.Loc.base { id := 8381 })],
 [("$res0", GoLean.Loc.base { id := 8380 }),
  ("votes", GoLean.Loc.base { id := 8379 }),
  ("c", GoLean.Loc.base { id := 8378 })]]) ([GoLean.Loc.base { id := 8384 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.initialization { id := "r2", typ := GoLean.GoCore.Ty.defined { key := "quorum.VoteResult" } },
     GoLean.GoCore.Stmt.call
       #[GoLean.GoCore.Assignee.var "r2"]
       { key := "quorum.MajorityConfig.VoteResult" }
 ...
 GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.eqCmp
     ...
     (GoLean.GoCore.Expr.var "r1")
     (GoLean.GoCore.Expr.var "r2"))
   (GoLean.GoCore.Stmt.block
     #[]
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res0") (GoLean.GoCore.Expr.var "r1"),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.ifThenElse
 ...
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign
       (GoLean.GoCore.Assignee.var "$res0")
       (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.uint8)),
     GoLean.GoCore.Stmt.returnStmt]]) ([[("r1", GoLean.Loc.base { id := 8381 })],
 [("$res0", GoLean.Loc.base { id := 8380 }),
  ("votes", GoLean.Loc.base { id := 8379 }),
  ("c", GoLean.Loc.base { id := 8378 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "result"])]) ([[("result", GoLean.Loc.base { id := 8377 })],
 [("$res2", GoLean.Loc.base { id := 8364 }),
  ("rejected", GoLean.Loc.base { id := 8363 }),
  ("granted", GoLean.Loc.base { id := 8362 }),
  ("p", GoLean.Loc.base { id := 8361 })]]) ([GoLean.Loc.base { id := 8380 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "granted") (GoLean.GoCore.Expr.var "granted"),
     ...
     GoLean.GoCore.Stmt.returnStmt]]) ([[("result", GoLean.Loc.base { id := 8377 })],
 [("$res2", GoLean.Loc.base { id := 8364 }),
  ("rejected", GoLean.Loc.base { id := 8363 }),
  ("granted", GoLean.Loc.base { id := 8362 }),
      ...
      (GoLean.GoCore.Stmt.block
        ...
        #[GoLean.GoCore.Stmt.assign
            ...
            (GoLean.GoCore.Expr.add
              (GoLean.GoCore.Expr.var "votedCnt")
              (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.int)))])
      (GoLean.GoCore.Stmt.seqn #[])]) ([[("id", GoLean.Loc.base { id := 8393 })],
 [("missing", GoLean.Loc.base { id := 8386 }), ("votedCnt", GoLean.Loc.base { id := 8385 })],
 [("$res0", GoLean.Loc.base { id := 8384 }),
  ("votes", GoLean.Loc.base { id := 8383 }),
  ("c", GoLean.Loc.base { id := 8382 })]]) (GoLean.Sym.Cont.mapIterK (some "id") (none) (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)) (GoLean.GoCore.Ty.defined { key := "struct{}" }) (GoLean.GoCore.Stmt.block
