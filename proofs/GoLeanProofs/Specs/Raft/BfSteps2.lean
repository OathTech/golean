...
theorem uC5_shape : uC5 = .next (.mapIterK (some "id") none uTyK uTyProg
    uB3 (some (.base ⟨2⟩)) #[uKeyV2] uStart3 uE3 uK3) := by
...
theorem uPick3_step (ρ : Valuation) (σ : ExecState)
    (a d : Int) (c₂ c₃ : Nat) (rest : Choices) :
    stepFn (γS (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) d) σ uS5)
      (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) d) uC5) (c₃ :: rest)
      = .ok (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) d) uC6,
          γS (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) d) σ uS6, rest) := by
  rw [uC5_shape, uC6_eq, uS6_eq]
...
theorem uC7_shape : uC7 = .next (.mapIterK (some "id") none uTyK uTyProg
    uB3 (some (.base ⟨2⟩)) #[uKeyV2, uKeyV3] uStart3 uE3 uK3) := by
  with_unfolding_all rfl
...
theorem uC8_eq : uC8 = .exec uB3
    ((uE3.pushScope).declare "id" (uS7.alloc uKeyV4 (some uTyK)).1)
    (.mapIterK (some "id") none uTyK uTyProg uB3 (some (.base ⟨2⟩))
      (Array.push #[uKeyV2, uKeyV3] uKeyV4) uStart3 uE3 uK3) := by
  unfold uC8 uP8
  rw [uC7_shape]
  rfl
...
theorem uPick4_step (ρ : Valuation) (σ : ExecState)
    (a : Int) (c₂ c₃ c₄ : Nat) (rest : Choices) :
    stepFn (γS (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) σ uS7)
      (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) uC7)
      (c₄ :: rest)
      = .ok (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) uC8,
          γS (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) σ uS8,
          rest) := by
  rw [uC7_shape, uC8_eq, uS8_eq]
  rcases (show c₂ % 3 = 0 ∨ c₂ % 3 = 1 ∨ c₂ % 3 = 2 by omega)
    with h2|h2|h2 <;>
    rcases (show c₃ % 2 = 0 ∨ c₃ % 2 = 1 by omega) with h3|h3
  · rw [(show uKey1 c₂ = 1 by unfold uKey1; rw [h2]; decide),
...
theorem uC9_shape : uC9 = .next (.mapIterK (some "id") none uTyK uTyProg
...
theorem uC10_eq : uC10 = .next uK3 := by
  unfold uC10 uP10
  rw [uC9_shape]
  rfl
...
theorem uStop_step (ρ : Valuation) (σ : ExecState)
    (a : Int) (c₂ c₃ : Nat) (ch : Choices) :
    stepFn (γS (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) σ uS9)
      (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) uC9) ch
      = .ok (γC (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) uC10,
          γS (uρ ρ a (uKey1 c₂) (uKey2 c₂ c₃) (uKey3 c₂ c₃)) σ uS10,
          ch) := by
  rw [uC9_shape, uC10_eq, uS10_eq]
  rcases (show c₂ % 3 = 0 ∨ c₂ % 3 = 1 ∨ c₂ % 3 = 2 by omega)
    with h2|h2|h2 <;>
    rcases (show c₃ % 2 = 0 ∨ c₃ % 2 = 1 by omega) with h3|h3
  · rw [(show uKey1 c₂ = 1 by unfold uKey1; rw [h2]; decide),
...
def uE11 : LocalEnv := match uC11 with
  | .retV _ (.stmtOpK _ _ _ _ e _) => e
  | _ => []
def uK11 : GoLean.Sym.Cont symDom := match uC11 with
  | .retV _ (.stmtOpK _ _ _ _ _ k) => k
  | _ => .stop
def uSlice11 : SliceValue :=
  { base := some (.base ⟨45⟩), offset := 0, len := 3, cap := 7 }

theorem uC11_shape : uC11 = .retV (.slice uSlice11)
    (.stmtOpK (.sortSlice (.int .uint64)) 0 [] [] uE11 uK11) := by
  with_unfolding_all rfl
