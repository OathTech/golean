...
def vrSB12 : SymState :=
  ...
  ((GoLean.Loc.base { id := 8385 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.int)))),
      ...
      (GoLean.GoCore.Stmt.block
        ...
        #[GoLean.GoCore.Stmt.assign
            ...
            (GoLean.GoCore.Expr.add
              (GoLean.GoCore.Expr.var "votedCnt")
              (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.int)))])
      (GoLean.GoCore.Stmt.seqn #[])]) ([[("id", GoLean.Loc.base { id := 8387 })],
      ...
      (GoLean.GoCore.Stmt.block
        ...
        #[GoLean.GoCore.Stmt.assign
            ...
            (GoLean.GoCore.Expr.add
              (GoLean.GoCore.Expr.var "votedCnt")
              (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.int)))])
      (GoLean.GoCore.Stmt.seqn #[])]) (some (GoLean.Loc.base { id := 1086 })) #[(GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 1) (GoLean.GoCore.IntKind.uint64))] #[(GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 1) (GoLean.GoCore.IntKind.uint64)),
  (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 2) (GoLean.GoCore.IntKind.uint64)),
  (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 3) (GoLean.GoCore.IntKind.uint64))] ([[("missing", GoLean.Loc.base { id := 8386 }), ("votedCnt", GoLean.Loc.base { id := 8385 })],
 [("$res0", GoLean.Loc.base { id := 8384 }),
  ("votes", GoLean.Loc.base { id := 8383 }),
