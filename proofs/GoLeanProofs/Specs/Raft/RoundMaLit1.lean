...
/-! # RoundMaLit1 — GENERATED literals (A4-U22 C2d; generator
`artifacts/probe/RoundMaGen.lean` — DO NOT EDIT BY HAND; anchor, the pick crossing, R1).

The MsgApp append-family FULL-ROUND fixture (anchor to anchor:
23,488 steps, 8 draws — the SEMANTIC delivery pick at round step 207
+ 7 latitude appendSpills), tree-propagated through 12 mirror windows
(states carry unreduced SymInt trees; crossings hand successors
values over the SAME trees, so kernel comparisons never γ-evaluate a
tree — the C2c template). γ-fidelity was generator-verified at every
boundary AND crossing (the pick's post = one appended iteration cell,
its config reflected + γ-checked). The window LINK theorems in
`RoundMaEq*.lean` (kernel rfl) re-check every literal against the
mirror. Six files for parallel elaboration (8.2 MB total). -/
...
def maSR0 : SymState :=
  ...
  ((GoLean.Loc.base { id := 6073 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int32))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 3) (GoLean.GoCore.IntKind.int32)))),
  ...
  (("Entries"), (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 6083 }), offset := 0, len := 1, cap := 1 }))),
  (("Commit"), (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6079 }))),
  (("Vote"), (GoLean.Sym.Value.nil)),
  ...
  ((GoLean.Loc.base { id := 6079 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 2) (GoLean.GoCore.IntKind.uint64)))),
...
def maSR1 : SymState :=
  ...
  (("lastTrm"), (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64))),
  (("got"), (GoLean.Sym.Value.map ({ base := some (GoLean.Loc.base { id := 1767 }) })))]))),
  ((GoLean.Loc.base { id := 1779 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raft.MemoryStorage" })) (GoLean.Sym.Value.struct ({ key := "raft.MemoryStorage" }) #[(("Mutex"), (GoLean.Sym.Value.syncData (GoLean.SyncPrim.mutex true))),
  (("hardState"), (GoLean.Sym.Value.nil)),
  (("snapshot"), (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1858 }))),
  (("ents"), (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 1900 }), offset := 0, len := 1, cap := 1 }))),
  ...
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.int)
    (GoLean.Sym.SymInt.add
      (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int) (GoLean.Sym.SymInt.lit 2))
      (GoLean.Sym.SymInt.lit 1)))) (GoLean.GoCore.IntKind.int))),
  (("lastIndex"), (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.int)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int) (GoLean.Sym.SymInt.lit 7))) (GoLean.GoCore.IntKind.int))),
  ...
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3))) (GoLean.GoCore.IntKind.int32)))),
  ...
  ((GoLean.Loc.base { id := 6113 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)) (GoLean.GoCore.IntKind.int32)))),
  ((GoLean.Loc.base { id := 6114 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.string)) (GoLean.Sym.Value.string ({ bytes := #[51] })))),
  ...
  (GoLean.Sym.SymInt.norm
    ...
    (GoLean.Sym.SymInt.norm
      (GoLean.GoCore.IntKind.int32)
      (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3))))) (GoLean.GoCore.IntKind.int)))),
  ((GoLean.Loc.base { id := 6116 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.string)) (GoLean.Sym.Value.string ({ bytes := #[51] })))),
  ((GoLean.Loc.base { id := 6117 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.string)) (GoLean.Sym.Value.string ({ bytes := #[51] })))),
        ...
        (GoLean.Sym.SymInt.norm
          ...
          (GoLean.Sym.SymInt.norm
            ...
            (GoLean.Sym.SymInt.norm
              ...
              (GoLean.Sym.SymInt.norm
                (GoLean.GoCore.IntKind.int32)
                (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)))))))
      10))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6119 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.string)) (GoLean.Sym.Value.string ({ bytes := #[51] })))),
  ((GoLean.Loc.base { id := 6120 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.string)) (GoLean.Sym.Value.string ({ bytes := #[51] })))),
  ...
  ((GoLean.Loc.base { id := 6131 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.string)) (GoLean.Sym.Value.string ({ bytes := #[114, 49, 32, 112, 105, 99, 107, 35, 48, 32, 116, 121, 112, 101, 51, 45, 62, 50] })))),
  ...
  ((GoLean.Loc.base { id := 6145 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)) (GoLean.GoCore.IntKind.int32)))),
  ...
  ((GoLean.Loc.base { id := 6157 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)) (GoLean.GoCore.IntKind.int32)))),
  ...
  ((GoLean.Loc.base { id := 6174 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int) (GoLean.Sym.SymInt.lit 0)) (GoLean.GoCore.IntKind.int)))),
  ...
  ((GoLean.Loc.base { id := 6177 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0)) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6178 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6179 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.int32)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3))) (GoLean.GoCore.IntKind.int32)))),
  ((GoLean.Loc.base { id := 6180 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6181 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)) (GoLean.GoCore.IntKind.int32)))),
  ...
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.int32)
    (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)))) (GoLean.GoCore.IntKind.int32)))),
  ((GoLean.Loc.base { id := 6183 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int) (GoLean.Sym.SymInt.lit 4)) (GoLean.GoCore.IntKind.int)))),
  ((GoLean.Loc.base { id := 6184 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6185 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.interface { key := "error" })) (GoLean.Sym.Value.nil))),
  ((GoLean.Loc.base { id := 6186 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.raft" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1989 })))),
  ...
  ((GoLean.Loc.base { id := 6188 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.interface { key := "error" })) (GoLean.Sym.Value.nil))),
  ((GoLean.Loc.base { id := 6189 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.int32)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3))) (GoLean.GoCore.IntKind.int32)))),
  ((GoLean.Loc.base { id := 6190 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6191 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)) (GoLean.GoCore.IntKind.int32)))),
  ((GoLean.Loc.base { id := 6192 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raftpb.MessageType" })) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.int32)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.int32)
    (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int32) (GoLean.Sym.SymInt.lit 3)))) (GoLean.GoCore.IntKind.int32)))),
  ((GoLean.Loc.base { id := 6193 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.int) (GoLean.Sym.SymInt.lit 1)) (GoLean.GoCore.IntKind.int)))),
  ...
  ((GoLean.Loc.base { id := 6195 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6196 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6197 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6198 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.raft" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1989 })))),
  ((GoLean.Loc.base { id := 6199 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6200 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raft.logSlice" })) (GoLean.Sym.Value.struct ({ key := "raft.logSlice" }) #[(("term"), (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm
        ...
        (GoLean.Sym.SymInt.norm
          ...
          (GoLean.Sym.SymInt.norm
            ...
            (GoLean.Sym.SymInt.norm
              ...
              (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1))))))))) (GoLean.GoCore.IntKind.uint64)))])),
  (("entries"), (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 6083 }), offset := 0, len := 1, cap := 1 })))]))),
  ((GoLean.Loc.base { id := 6201 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6202 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raft.logSlice" })) (GoLean.Sym.Value.struct ({ key := "raft.logSlice" }) #[(("term"), (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm
      ...
      (GoLean.Sym.SymInt.norm
        ...
        (GoLean.Sym.SymInt.norm
          ...
          (GoLean.Sym.SymInt.norm
            ...
            (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)))))))) (GoLean.GoCore.IntKind.uint64)))])),
  (("entries"), (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 6083 }), offset := 0, len := 1, cap := 1 })))]))),
  ((GoLean.Loc.base { id := 6203 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6204 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6205 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0)) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6206 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0)))) (GoLean.GoCore.IntKind.uint64)))),
  ...
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6211 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6212 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6213 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6214 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6215 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raft.entryID" })) (GoLean.Sym.Value.struct ({ key := "raft.entryID" }) #[(("term"), (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm
  ...
  (GoLean.Sym.SymInt.norm
    ...
    (GoLean.Sym.SymInt.norm
      ...
      (GoLean.Sym.SymInt.norm
        (GoLean.GoCore.IntKind.uint64)
        (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)))))) (GoLean.GoCore.IntKind.uint64)))]))),
  ((GoLean.Loc.base { id := 6216 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.slice (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Entry" })))) (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 6083 }), offset := 0, len := 1, cap := 1 })))),
  ((GoLean.Loc.base { id := 6217 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6218 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.slice (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Entry" })))) (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 6083 }), offset := 0, len := 1, cap := 1 })))),
  ((GoLean.Loc.base { id := 6219 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.slice (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Entry" })))) (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 6083 }), offset := 0, len := 1, cap := 1 })))),
  ((GoLean.Loc.base { id := 6220 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 2))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6221 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 6076 })))),
  ((GoLean.Loc.base { id := 6222 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 2)) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6223 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6224 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6225 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.raftLog" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1949 })))),
  ((GoLean.Loc.base { id := 6226 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raft.logSlice" })) (GoLean.Sym.Value.struct ({ key := "raft.logSlice" }) #[(("term"), (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm
          ...
          (GoLean.Sym.SymInt.norm
            ...
            (GoLean.Sym.SymInt.norm
              ...
              (GoLean.Sym.SymInt.norm
                ...
                (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)))))))))) (GoLean.GoCore.IntKind.uint64)))])),
  (("entries"), (GoLean.Sym.Value.slice ({ base := some (GoLean.Loc.base { id := 6083 }), offset := 0, len := 1, cap := 1 })))]))),
  ((GoLean.Loc.base { id := 6227 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 2)))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6228 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6229 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6230 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6231 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.raftLog" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1949 })))),
  ((GoLean.Loc.base { id := 6232 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.defined { key := "raft.entryID" })) (GoLean.Sym.Value.struct ({ key := "raft.entryID" }) #[(("term"), (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm
            ...
            (GoLean.Sym.SymInt.norm
              ...
              (GoLean.Sym.SymInt.norm
                ...
                (GoLean.Sym.SymInt.norm
                  (GoLean.GoCore.IntKind.uint64)
                  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1))))))))))) (GoLean.GoCore.IntKind.uint64)))]))),
  ((GoLean.Loc.base { id := 6233 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6234 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6235 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.interface { key := "error" })) (GoLean.Sym.Value.nil))),
  ((GoLean.Loc.base { id := 6236 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.raftLog" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1949 })))),
  ((GoLean.Loc.base { id := 6237 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm
              ...
              (GoLean.Sym.SymInt.norm
                ...
                (GoLean.Sym.SymInt.norm
                  ...
                  (GoLean.Sym.SymInt.norm
                    (GoLean.GoCore.IntKind.uint64)
                    (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)))))))))))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6238 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6239 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.interface { key := "error" })) (GoLean.Sym.Value.nil))),
  ((GoLean.Loc.base { id := 6240 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6241 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6242 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.unstable" }))) (GoLean.Sym.Value.addr (GoLean.Loc.field (GoLean.Loc.base { id := 1949 }) { key := "raft.raftLog" } "unstable")))),
  ((GoLean.Loc.base { id := 6243 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm
    (GoLean.GoCore.IntKind.uint64)
    (GoLean.Sym.SymInt.norm
                ...
                (GoLean.Sym.SymInt.norm
                  ...
                  (GoLean.Sym.SymInt.norm
                    ...
                    (GoLean.Sym.SymInt.norm
                      (GoLean.GoCore.IntKind.uint64)
                      (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1))))))))))))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6244 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0)) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6245 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6246 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.not (GoLean.Sym.SymBool.lit true))))),
  ((GoLean.Loc.base { id := 6247 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6248 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.raftLog" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1949 })))),
  ((GoLean.Loc.base { id := 6249 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6250 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6251 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6252 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.unstable" }))) (GoLean.Sym.Value.addr (GoLean.Loc.field (GoLean.Loc.base { id := 1949 }) { key := "raft.raftLog" } "unstable")))),
  ((GoLean.Loc.base { id := 6253 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 0)) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6254 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.bool)) (GoLean.Sym.Value.bool (GoLean.Sym.SymBool.lit false)))),
  ((GoLean.Loc.base { id := 6255 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6256 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.interface { key := "error" })) (GoLean.Sym.Value.nil))),
  ((GoLean.Loc.base { id := 6257 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.MemoryStorage" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1779 })))),
  ((GoLean.Loc.base { id := 6258 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6259 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.interface { key := "error" })) (GoLean.Sym.Value.nil))),
  ((GoLean.Loc.base { id := 6260 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6261 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raft.MemoryStorage" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1779 })))),
  ((GoLean.Loc.base { id := 6262 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.lit 0) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6263 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm
  (GoLean.GoCore.IntKind.uint64)
  (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1))) (GoLean.GoCore.IntKind.uint64)))),
  ((GoLean.Loc.base { id := 6264 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Entry" }))) (GoLean.Sym.Value.addr (GoLean.Loc.base { id := 1898 })))),
  ((GoLean.Loc.base { id := 6265 }), (GoLean.Sym.HeapCell.mk (some (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))) (GoLean.Sym.Value.int (GoLean.Sym.SymInt.norm (GoLean.GoCore.IntKind.uint64) (GoLean.Sym.SymInt.lit 1)) (GoLean.GoCore.IntKind.uint64))))]
  6266)

def maCR1 : SymConfig :=
  (GoLean.Sym.Config.next (GoLean.Sym.Cont.storeK [] [] (GoLean.GoCore.Stmt.seqn #[]) ([[("$c1961", GoLean.Loc.base { id := 6263 })],
 [("$res0", GoLean.Loc.base { id := 6262 }), ("ms", GoLean.Loc.base { id := 6261 })]]) (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign
       (GoLean.GoCore.Assignee.var "$res0")
       (GoLean.GoCore.Expr.add
         (GoLean.GoCore.Expr.var "$c1961")
         (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.uint64))),
     GoLean.GoCore.Stmt.returnStmt]]) ([[("$c1961", GoLean.Loc.base { id := 6263 })],
 [("$res0", GoLean.Loc.base { id := 6262 }), ("ms", GoLean.Loc.base { id := 6261 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "$c1960"])]) ([[("$c1960", GoLean.Loc.base { id := 6260 })],
 [("$res1", GoLean.Loc.base { id := 6259 }),
  ("$res0", GoLean.Loc.base { id := 6258 }),
  ("ms", GoLean.Loc.base { id := 6257 })]]) ([GoLean.Loc.base { id := 6262 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res0") (GoLean.GoCore.Expr.var "$c1960"),
     GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res1") (GoLean.GoCore.Expr.nil none),
     GoLean.GoCore.Stmt.returnStmt]]) ([[("$c1960", GoLean.Loc.base { id := 6260 })],
 [("$res1", GoLean.Loc.base { id := 6259 }),
  ("$res0", GoLean.Loc.base { id := 6258 }),
  ("ms", GoLean.Loc.base { id := 6257 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "index"]),
 (GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "err"])]) ([[("err", GoLean.Loc.base { id := 6256 }), ("index", GoLean.Loc.base { id := 6255 })],
 [("$res0", GoLean.Loc.base { id := 6249 }), ("l", GoLean.Loc.base { id := 6248 })]]) ([GoLean.Loc.base { id := 6258 }, GoLean.Loc.base { id := 6259 }]) [((GoLean.Sym.Value.funcVal ({ key := "raft.MemoryStorage.FirstIndex$deferSync0" }) []), [(GoLean.Sym.Value.addr (GoLean.Loc.field (GoLean.Loc.base { id := 1779 }) { key := "raft.MemoryStorage" } "Mutex"))])] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.neqCmp
     (GoLean.GoCore.Ty.interface { key := "error" })
     (GoLean.GoCore.Expr.var "err")
     (GoLean.GoCore.Expr.nil none))
   (GoLean.GoCore.Stmt.block #[] #[GoLean.GoCore.Stmt.panicStmt (GoLean.GoCore.Expr.var "err")])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res0") (GoLean.GoCore.Expr.var "index"),
     GoLean.GoCore.Stmt.returnStmt]]) ([[("err", GoLean.Loc.base { id := 6256 }), ("index", GoLean.Loc.base { id := 6255 })],
 [("$res0", GoLean.Loc.base { id := 6249 }), ("l", GoLean.Loc.base { id := 6248 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "$c1055"])]) ([[("$c1055", GoLean.Loc.base { id := 6247 })],
 [("$res1", GoLean.Loc.base { id := 6239 }),
  ("$res0", GoLean.Loc.base { id := 6238 }),
  ("i", GoLean.Loc.base { id := 6237 }),
  ("l", GoLean.Loc.base { id := 6236 })]]) ([GoLean.Loc.base { id := 6249 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.lessCmp
     (GoLean.GoCore.Expr.add (GoLean.GoCore.Expr.var "i") (GoLean.GoCore.Expr.intLit 1 (GoLean.GoCore.IntKind.uint64)))
     (GoLean.GoCore.Expr.var "$c1055"))
   (GoLean.GoCore.Stmt.block
     #[]
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign
           ...
           GoLean.GoCore.Stmt.assign
             (GoLean.GoCore.Assignee.var "$res1")
             (GoLean.GoCore.Expr.deref
               (GoLean.GoCore.Expr.locLit (GoLean.Loc.base { id := 23 }))
               (GoLean.GoCore.Ty.interface { key := "error" })),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.initialization { id := "$c1056", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64) },
     GoLean.GoCore.Stmt.call
       #[GoLean.GoCore.Assignee.var "$c1056"]
       { key := "raft.raftLog.lastIndex" }
       #[GoLean.GoCore.Expr.var "l"]],
 GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.greaterCmp (GoLean.GoCore.Expr.var "i") (GoLean.GoCore.Expr.var "$c1056"))
   (GoLean.GoCore.Stmt.block
     #[]
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign
           ...
           GoLean.GoCore.Stmt.assign
             (GoLean.GoCore.Assignee.var "$res1")
             (GoLean.GoCore.Expr.deref
               (GoLean.GoCore.Expr.locLit (GoLean.Loc.base { id := 25 }))
               (GoLean.GoCore.Ty.interface { key := "error" })),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.initialization { id := "t", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64) },
     GoLean.GoCore.Stmt.initialization { id := "err", typ := GoLean.GoCore.Ty.interface { key := "error" } },
     GoLean.GoCore.Stmt.call
       #[GoLean.GoCore.Assignee.var "t", GoLean.GoCore.Assignee.var "err"]
       { key := "raft.Storage.Term" }
       #[GoLean.GoCore.Expr.fieldGet
           (GoLean.GoCore.Expr.deref (GoLean.GoCore.Expr.var "l") (GoLean.GoCore.Ty.defined { key := "raft.raftLog" }))
           { key := "raft.raftLog" }
           "storage",
   ...
   (GoLean.GoCore.Stmt.block
     ...
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign
             (GoLean.GoCore.Assignee.var "$res0")
             (GoLean.GoCore.Expr.intLit 0 (GoLean.GoCore.IntKind.uint64)),
           GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res1") (GoLean.GoCore.Expr.var "err"),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.panicStmt (GoLean.GoCore.Expr.var "err")]) ([[("$c1055", GoLean.Loc.base { id := 6247 })],
 [("$res1", GoLean.Loc.base { id := 6239 }),
  ("$res0", GoLean.Loc.base { id := 6238 }),
  ("i", GoLean.Loc.base { id := 6237 }),
  ("l", GoLean.Loc.base { id := 6236 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "t"]),
 (GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "err"])]) ([[("err", GoLean.Loc.base { id := 6235 }), ("t", GoLean.Loc.base { id := 6234 })],
 [("$res0", GoLean.Loc.base { id := 6233 }),
  ("id", GoLean.Loc.base { id := 6232 }),
  ("l", GoLean.Loc.base { id := 6231 })]]) ([GoLean.Loc.base { id := 6238 }, GoLean.Loc.base { id := 6239 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.neqCmp
     (GoLean.GoCore.Ty.interface { key := "error" })
     (GoLean.GoCore.Expr.var "err")
     (GoLean.GoCore.Expr.nil none))
   (GoLean.GoCore.Stmt.block
     #[]
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res0") (GoLean.GoCore.Expr.boolLit false),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign
       ...
       (GoLean.GoCore.Expr.eqCmp
         ...
         (GoLean.GoCore.Expr.var "t")
         (GoLean.GoCore.Expr.fieldGet (GoLean.GoCore.Expr.var "id") { key := "raft.entryID" } "term")),
     GoLean.GoCore.Stmt.returnStmt]]) ([[("err", GoLean.Loc.base { id := 6235 }), ("t", GoLean.Loc.base { id := 6234 })],
 [("$res0", GoLean.Loc.base { id := 6233 }),
  ("id", GoLean.Loc.base { id := 6232 }),
  ("l", GoLean.Loc.base { id := 6231 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "$c1020"])]) ([[("$c1020", GoLean.Loc.base { id := 6230 })],
 [("ok", GoLean.Loc.base { id := 6229 }),
  ("lastnewi", GoLean.Loc.base { id := 6228 }),
  ("committed", GoLean.Loc.base { id := 6227 }),
  ("a", GoLean.Loc.base { id := 6226 }),
  ("l", GoLean.Loc.base { id := 6225 })]]) ([GoLean.Loc.base { id := 6233 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.not (GoLean.GoCore.Expr.var "$c1020"))
   (GoLean.GoCore.Stmt.block
     #[]
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign
             (GoLean.GoCore.Assignee.var "lastnewi")
             (GoLean.GoCore.Expr.intLit 0 (GoLean.GoCore.IntKind.uint64)),
           GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "ok") (GoLean.GoCore.Expr.boolLit false),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[]),
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign
       ...
       (GoLean.GoCore.Expr.add
         (GoLean.GoCore.Expr.fieldGet
           (GoLean.GoCore.Expr.fieldGet (GoLean.GoCore.Expr.var "a") { key := "raft.logSlice" } "prev")
           { key := "raft.entryID" }
           "index")
         (GoLean.GoCore.Expr.convert
           (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))
           (GoLean.GoCore.Expr.length
             (GoLean.GoCore.Expr.fieldGet (GoLean.GoCore.Expr.var "a") { key := "raft.logSlice" } "entries")
             (some (GoLean.GoCore.Ty.slice
                (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Entry" })))))))],
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.initialization { id := "ci", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64) },
     GoLean.GoCore.Stmt.call
       #[GoLean.GoCore.Assignee.var "ci"]
       { key := "raft.raftLog.findConflict" }
       #[GoLean.GoCore.Expr.var "l",
         GoLean.GoCore.Expr.fieldGet (GoLean.GoCore.Expr.var "a") { key := "raft.logSlice" } "entries"]],
 GoLean.GoCore.Stmt.breakable
   (GoLean.GoCore.Stmt.block
     ...
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.initialization
             { id := "$swi1023", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int) },
           GoLean.GoCore.Stmt.assign
             (GoLean.GoCore.Assignee.var "$swi1023")
             (GoLean.GoCore.Expr.intLit 2 (GoLean.GoCore.IntKind.int))],
       GoLean.GoCore.Stmt.block
         #[]
         #[GoLean.GoCore.Stmt.ifThenElse
             ...
             (GoLean.GoCore.Stmt.block
               ...
               #[GoLean.GoCore.Stmt.ifThenElse
                   ...
                   (GoLean.GoCore.Stmt.seqn #[])])],
       GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.initialization { id := "$swf1023", typ := GoLean.GoCore.Ty.bool },
           GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$swf1023") (GoLean.GoCore.Expr.boolLit false)],
       GoLean.GoCore.Stmt.ifThenElse
         (GoLean.GoCore.Expr.or
           (GoLean.GoCore.Expr.var "$swf1023")
           (GoLean.GoCore.Expr.eqCmp
             (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.int))
             (GoLean.GoCore.Expr.var "$swi1023")
             (GoLean.GoCore.Expr.intLit 0 (GoLean.GoCore.IntKind.int))))
         (GoLean.GoCore.Stmt.block
           #[]
           #[GoLean.GoCore.Stmt.seqn
         ...
         (GoLean.GoCore.Stmt.block
           ...
           #[GoLean.GoCore.Stmt.seqn
             ...
             GoLean.GoCore.Stmt.block
               ...
               #[GoLean.GoCore.Stmt.seqn
                   #[GoLean.GoCore.Stmt.initialization
                       { id := "$c1021", typ := GoLean.GoCore.Ty.slice (GoLean.GoCore.Ty.interface { key := "any" }) },
                     GoLean.GoCore.Stmt.makeSlice
                       (GoLean.GoCore.Assignee.var "$c1021")
                 ...
                 GoLean.GoCore.Stmt.call
                   ...
                   #[GoLean.GoCore.Expr.fieldGet
                       ...
                       "logger",
                     GoLean.GoCore.Expr.stringLit
                       { bytes := #[101, 110, 116, 114, 121, 32, 37, 100, 32, 99, 111, 110, 102, 108, 105, 99, 116, 32,
                                    119, 105, 116, 104, 32, 99, 111, 109, 109, 105, 116, 116, 101, 100, 32, 101, 110,
                                    116, 114, 121, 32, 91, 99, 111, 109, 109, 105, 116, 116, 101, 100, 40, 37, 100, 41,
                                    93] },
                     GoLean.GoCore.Expr.var "$c1021"]]])
         (GoLean.GoCore.Stmt.seqn #[]),
       GoLean.GoCore.Stmt.ifThenElse
         ...
         (GoLean.GoCore.Stmt.block
           ...
           #[GoLean.GoCore.Stmt.seqn
             ...
             GoLean.GoCore.Stmt.block
               ...
               #[GoLean.GoCore.Stmt.seqn
                   #[GoLean.GoCore.Stmt.initialization
                       { id := "offset", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64) },
                     GoLean.GoCore.Stmt.assign
                       (GoLean.GoCore.Assignee.var "offset")
                       (GoLean.GoCore.Expr.add
                         (GoLean.GoCore.Expr.fieldGet
                           (GoLean.GoCore.Expr.fieldGet (GoLean.GoCore.Expr.var "a") { key := "raft.logSlice" } "prev")
                           { key := "raft.entryID" }
                 ...
                 GoLean.GoCore.Stmt.ifThenElse
                   (GoLean.GoCore.Expr.greaterCmp
                     (GoLean.GoCore.Expr.sub (GoLean.GoCore.Expr.var "ci") (GoLean.GoCore.Expr.var "offset"))
                     (GoLean.GoCore.Expr.convert
                       (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64))
                       (GoLean.GoCore.Expr.length
                         (GoLean.GoCore.Expr.fieldGet (GoLean.GoCore.Expr.var "a") { key := "raft.logSlice" } "entries")
                   ...
                   (GoLean.GoCore.Stmt.block
                     ...
                     #[GoLean.GoCore.Stmt.seqn
                         #[GoLean.GoCore.Stmt.initialization
                           ...
                           GoLean.GoCore.Stmt.makeSlice
                             (GoLean.GoCore.Assignee.var "$c1022")
                             (GoLean.GoCore.Ty.interface { key := "any" })
                             (GoLean.GoCore.Expr.intLit 2 (GoLean.GoCore.IntKind.int))
                             (some (GoLean.GoCore.Expr.intLit 2 (GoLean.GoCore.IntKind.int))),
                           GoLean.GoCore.Stmt.assign
                       ...
                       GoLean.GoCore.Stmt.call
                         ...
                         #[GoLean.GoCore.Expr.fieldGet
                             ...
                             "logger",
                           GoLean.GoCore.Expr.stringLit
                             { bytes := #[105, 110, 100, 101, 120, 44, 32, 37, 100, 44, 32, 105, 115, 32, 111, 117, 116,
                                          32, 111, 102, 32, 114, 97, 110, 103, 101, 32, 91, 37, 100, 93] },
                           GoLean.GoCore.Expr.var "$c1022"]])
                   (GoLean.GoCore.Stmt.seqn #[]),
                 GoLean.GoCore.Stmt.seqn
                   #[GoLean.GoCore.Stmt.initialization
 ...
 GoLean.GoCore.Stmt.call
   #[]
   { key := "raft.raftLog.commitTo" }
   #[GoLean.GoCore.Expr.var "l",
     GoLean.GoCore.Expr.minOf #[GoLean.GoCore.Expr.var "committed", GoLean.GoCore.Expr.var "lastnewi"]],
 GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "lastnewi") (GoLean.GoCore.Expr.var "lastnewi"),
     GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "ok") (GoLean.GoCore.Expr.boolLit true),
     GoLean.GoCore.Stmt.returnStmt]]) ([[("$c1020", GoLean.Loc.base { id := 6230 })],
 [("ok", GoLean.Loc.base { id := 6229 }),
  ("lastnewi", GoLean.Loc.base { id := 6228 }),
  ("committed", GoLean.Loc.base { id := 6227 }),
  ("a", GoLean.Loc.base { id := 6226 }),
  ("l", GoLean.Loc.base { id := 6225 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "mlastIndex"]),
 (GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "ok"])]) ([[("ok", GoLean.Loc.base { id := 6224 }), ("mlastIndex", GoLean.Loc.base { id := 6223 })],
 [("$c1625", GoLean.Loc.base { id := 6220 }), ("a", GoLean.Loc.base { id := 6200 })],
 [("m", GoLean.Loc.base { id := 6199 }), ("r", GoLean.Loc.base { id := 6198 })]]) ([GoLean.Loc.base { id := 6228 }, GoLean.Loc.base { id := 6229 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.ifThenElse
   ...
   (GoLean.GoCore.Stmt.block
     ...
     #[GoLean.GoCore.Stmt.seqn
       ...
       GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.initialization
             { id := "$c1628", typ := GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)) },
       ...
       GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.initialization
             { id := "$c1629", typ := GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64)) },
           GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$c1629") (GoLean.GoCore.Expr.var "$c1628")],
       GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.initialization
             { id := "$c1630", typ := GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }) },
           GoLean.GoCore.Stmt.newValue
       ...
       GoLean.GoCore.Stmt.returnStmt])
   (GoLean.GoCore.Stmt.seqn #[])]) ([[("ok", GoLean.Loc.base { id := 6224 }), ("mlastIndex", GoLean.Loc.base { id := 6223 })],
 [("$c1625", GoLean.Loc.base { id := 6220 }), ("a", GoLean.Loc.base { id := 6200 })],
 [("m", GoLean.Loc.base { id := 6199 }), ("r", GoLean.Loc.base { id := 6198 })]]) (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
         ...
         #[GoLean.GoCore.Expr.var "$c1644",
           ...
           GoLean.GoCore.Expr.defaultValue
             (GoLean.GoCore.Ty.slice
               (GoLean.GoCore.Ty.pointer (GoLean.GoCore.Ty.defined { key := "raftpb.Message" })))])
       (some (GoLean.GoCore.Ty.defined { key := "raftpb.Message" }))],
 GoLean.GoCore.Stmt.call #[] { key := "raft.raft.send" } #[GoLean.GoCore.Expr.var "r", GoLean.GoCore.Expr.var "$c1654"]]) ([[("$c1625", GoLean.Loc.base { id := 6220 }), ("a", GoLean.Loc.base { id := 6200 })],
 [("m", GoLean.Loc.base { id := 6199 }), ("r", GoLean.Loc.base { id := 6198 })]]) (GoLean.Sym.Cont.frame ([]) ([[("$c1588", GoLean.Loc.base { id := 6195 })],
 [],
 [("$swf1610", GoLean.Loc.base { id := 6194 }),
  ("$swi1610", GoLean.Loc.base { id := 6193 }),
  ("$sw1584", GoLean.Loc.base { id := 6192 }),
  ("$c1583", GoLean.Loc.base { id := 6189 })],
 [],
 [("$res0", GoLean.Loc.base { id := 6188 }),
  ("m", GoLean.Loc.base { id := 6187 }),
  ("r", GoLean.Loc.base { id := 6186 })]]) ([]) [] (GoLean.Sym.Cont.seq ([]) ([[("$c1588", GoLean.Loc.base { id := 6195 })],
 [],
 [("$swf1610", GoLean.Loc.base { id := 6194 }),
  ("$swi1610", GoLean.Loc.base { id := 6193 }),
  ("$sw1584", GoLean.Loc.base { id := 6192 }),
 ...
 [("$res0", GoLean.Loc.base { id := 6188 }),
  ("m", GoLean.Loc.base { id := 6187 }),
  ("r", GoLean.Loc.base { id := 6186 })]]) (GoLean.Sym.Cont.seq ([]) ([[],
 [("$swf1610", GoLean.Loc.base { id := 6194 }),
  ("$swi1610", GoLean.Loc.base { id := 6193 }),
  ("$sw1584", GoLean.Loc.base { id := 6192 }),
  ("$c1583", GoLean.Loc.base { id := 6189 })],
 ...
 [("$res0", GoLean.Loc.base { id := 6188 }),
  ("m", GoLean.Loc.base { id := 6187 }),
  ("r", GoLean.Loc.base { id := 6186 })]]) (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.or
     ...
     #[GoLean.GoCore.Stmt.seqn
       ...
       GoLean.GoCore.Stmt.block
         ...
         #[GoLean.GoCore.Stmt.seqn
           ...
           GoLean.GoCore.Stmt.seqn
             #[GoLean.GoCore.Stmt.initialization
                 { id := "$c1589", typ := GoLean.GoCore.Ty.int (GoLean.GoCore.IntKind.uint64) },
               GoLean.GoCore.Stmt.call
                 #[GoLean.GoCore.Assignee.var "$c1589"]
                 { key := "raftpb.Message.GetFrom" }
                 #[GoLean.GoCore.Expr.var "m"]],
           GoLean.GoCore.Stmt.seqn
             #[GoLean.GoCore.Stmt.assign
 ...
 GoLean.GoCore.Stmt.ifThenElse
   ...
   (GoLean.GoCore.Stmt.seqn #[])]) ([[("$swf1610", GoLean.Loc.base { id := 6194 }),
  ("$swi1610", GoLean.Loc.base { id := 6193 }),
  ("$sw1584", GoLean.Loc.base { id := 6192 }),
  ("$c1583", GoLean.Loc.base { id := 6189 })],
 [],
 [("$res0", GoLean.Loc.base { id := 6188 }),
  ("m", GoLean.Loc.base { id := 6187 }),
  ("r", GoLean.Loc.base { id := 6186 })]]) (GoLean.Sym.Cont.breakableK (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res0") (GoLean.GoCore.Expr.nil none),
     GoLean.GoCore.Stmt.returnStmt]]) ([[],
 [("$res0", GoLean.Loc.base { id := 6188 }),
  ("m", GoLean.Loc.base { id := 6187 }),
  ("r", GoLean.Loc.base { id := 6186 })]]) (GoLean.Sym.Cont.frame ([(GoLean.GoCore.Machine.TargetShape.chain [], [GoLean.GoCore.Expr.ref "err"])]) ([[("err", GoLean.Loc.base { id := 6185 })],
 [],
 [("$swf1467", GoLean.Loc.base { id := 6184 }),
  ("$swi1467", GoLean.Loc.base { id := 6183 }),
  ("$sw1419", GoLean.Loc.base { id := 6182 }),
  ("$c1418", GoLean.Loc.base { id := 6179 })],
 [],
 [("$res0", GoLean.Loc.base { id := 6171 }),
  ("m", GoLean.Loc.base { id := 6170 }),
  ("r", GoLean.Loc.base { id := 6169 })]]) ([GoLean.Loc.base { id := 6188 }]) [] (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.ifThenElse
   (GoLean.GoCore.Expr.neqCmp
     (GoLean.GoCore.Ty.interface { key := "error" })
     (GoLean.GoCore.Expr.var "err")
     (GoLean.GoCore.Expr.nil none))
   (GoLean.GoCore.Stmt.block
     ...
     #[GoLean.GoCore.Stmt.seqn
         #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res0") (GoLean.GoCore.Expr.var "err"),
           GoLean.GoCore.Stmt.returnStmt]])
   (GoLean.GoCore.Stmt.seqn #[])]) ([[("err", GoLean.Loc.base { id := 6185 })],
 [],
 [("$swf1467", GoLean.Loc.base { id := 6184 }),
  ("$swi1467", GoLean.Loc.base { id := 6183 }),
  ("$sw1419", GoLean.Loc.base { id := 6182 }),
 ...
 [("$res0", GoLean.Loc.base { id := 6171 }),
  ("m", GoLean.Loc.base { id := 6170 }),
  ("r", GoLean.Loc.base { id := 6169 })]]) (GoLean.Sym.Cont.seq ([]) ([[("$swf1467", GoLean.Loc.base { id := 6184 }),
  ("$swi1467", GoLean.Loc.base { id := 6183 }),
  ("$sw1419", GoLean.Loc.base { id := 6182 }),
  ("$c1418", GoLean.Loc.base { id := 6179 })],
 [],
 [("$res0", GoLean.Loc.base { id := 6171 }),
  ("m", GoLean.Loc.base { id := 6170 }),
  ("r", GoLean.Loc.base { id := 6169 })]]) (GoLean.Sym.Cont.breakableK (GoLean.Sym.Cont.seq ([GoLean.GoCore.Stmt.seqn
   #[GoLean.GoCore.Stmt.assign (GoLean.GoCore.Assignee.var "$res0") (GoLean.GoCore.Expr.nil none),
     GoLean.GoCore.Stmt.returnStmt]]) ([[],
 [("$res0", GoLean.Loc.base { id := 6171 }),
  ("m", GoLean.Loc.base { id := 6170 }),
 ...
 [("$res4", GoLean.Loc.base { id := 102 }),
  ...
  ("$res2", GoLean.Loc.base { id := 100 }),
  ("$res1", GoLean.Loc.base { id := 99 }),
  ("$res0", GoLean.Loc.base { id := 98 })]]) (GoLean.Sym.Cont.frame ([]) ([]) ([]) [] (GoLean.Sym.Cont.stop) false)) false)))))))) false))) false)) false)))))) false)))))) false))) false)) false)) false)) false)) false)) false))))
